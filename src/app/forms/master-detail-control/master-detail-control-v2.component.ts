...
import { GenericControlProvider, GenericControlValueAccessorV2 } from '../GenericControlValueAccessor';
...
export class MasterDetailControlComponent extends GenericControlValueAccessorV2<any> implements OnInit {
  // items: string[] = [
  //   'what is your name?',
  //   'what is you age?'
  // ];
